...
<table width="100%" border="0" bgcolor="#999999"cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="20%"><div align="center" class="style16"><a href="food_order.php" target="_self">Food Oder </a></div></td>
	...
	<?php
		...
		if($_SESSION['login'] == 1 and strcmp($user_type,"Admin")==0)
			echo "<a herf='food_delivery.php' target='_self'> Food Delivery</a>";
	?>
	</div></td>
