<?php
	...
	if(isset($_POST['order_now']))
	{
		...
		if(!empty($cus_id) and !empty($cus_id) and !empty($cus_address) and !empty($phone_num) and !empty($food_name) and !empty($food_category) and !empty($total_peices)
		...
		if($result = mysqli_query($conn,$sql))
			{
				...
				{
					$ins = "INSERT INTO food_info(`cus_id`, `cus_name`, `cus_address`, `phone_num`, `food_name`, `food_category`,`total_peices`, `food_price`, `order_date`) VALUES ('$cus_id','$cus_name', '$cus_address', '$phone_num', '$food_name', '$food_category', '$total_peices', '$food_price', '$order_date')";
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="2" cellpadding="2">
      ...
      <tr>
        ...
        <td class="style5"><div align="center"><span class="style8"><strong>:</strong></span></div></td>
      ...
      <tr>
        ...
        <td class="style5"><div align="center" class="style7">:</div></td>
        <td class="style5"><input type="text" name="food_name" size="30" class="style5" /></td>
      </tr>
      <tr>
        <td class="style5"><div align="right">Food Category </div></td>
        <td class="style5"><div align="center" class="style7">:</div></td>
        <td class="style5"><input list="food_cat" name="food_category" style="width:40%" class="style5" />
      ...
      <tr>
        ...
        <td class="style5"><div align="center" class="style7">:</div></td>
        <td><div><input type="number" name="food_price" class="style5" /></div></td>
      </tr>
      <tr>
        <td class="style5"><div align="right">Order Date</div></td>
        <td class="style5"><div align="center" class="style7">:</div></td>
        <td><input type="date" name="order_date" class="style5" /></td>
      </tr>
      <tr>
